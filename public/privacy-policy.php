...
<main class="flex w-full py-10">
  <section class="px-2 mx-auto max-w-5xl leading-6">
    ...
    <p>This Privacy Policy applies only to our online activities and is valid for visitors to our
      ...
      <?php echo $name; ?>. This policy is not applicable to any information collected offline or
    ...
    <p>Log Files</p>
    <p class="pt-3"><?php echo $name; ?> follows a standard procedure of using log files. These
      files log visitors when they visit websites. All hosting companies do this and a part of
      hosting services' analytics. The information collected by log files includes internet protocol
      ...
      Generator and the Disclaimer Generator.</p>
    ...
    <p>Another part of our priority is adding protection for children while using the internet. We
      ...
      online activity.</p>
    <p><?php echo $name; ?> does not knowingly collect any Personal Identifiable Information from
    ...
    <p>Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web
      ...
      <?php echo $name; ?>, which are sent directly to users' browser. They automatically receive
    ...
    <p>Note that <?php echo $name; ?> has no access to or control over these cookies that are used
      by third-party advertisers.</p>
    <h4 class="pt-3 pb-1 text-xl">Third-Party Privacy Policies</h4>
    <p><?php echo $name; ?>' Privacy Policy does not apply to other advertisers or websites. Thus,
    ...
    <p class="pt-3 pb-1 text-xl">Under the CCPA, among other rights, California consumers have the
      right to:</p>
    ...
    <p>Request that a business that sells a consumer's personal data, not sell the consumer's
      personal data.</p>
    <p>If you make a request, <?php echo $name; ?> we have one month to respond to you. If you would
    ...
    <p>The right to data portability – You have the right to request that we transfer the data that
      we have collected to another organization, or directly to you, under certain terms.
    <h4 class="pt-3 pb-1 text-xl">Cookies and Web Beacons</h4>
    <p>Like any other website, <?php echo $name; ?> uses 'cookies'. These cookies are used to store
    ...
    <p class="mt-3">For more information obout our cookies or for opting out please update your
      <button class="underline" aria-label="View cookie settings" data-cc="c-settings">Cookie
        Settings</button>
    </p>
  </section>
</main>
