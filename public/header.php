        ...
        <div class="bg-neutral-400 dark:bg-neutral-900 hidden md:block">
            <nav class="flex max-w-5xl mx-auto px-4 py-1 justify-evenly w-full">
                ...
                <div class="flex justify-evenly my-auto text-sm">
                    ...
                    <p class="flex">&nbsp &nbsp; <svg aria-hidden="true" focusable="false" data-prefix="far"
                            data-icon="clock" class="svg-inline--fa fa-clock fa-w-16 h-5 w-5 my-auto" role="img"
                ...
                <label for="toggle" id="checkbox"
                    ...
                    <div class="relative">
                        ...
                        <div id="dot"
                            class="dot absolute left-1 top-1 w-5 h-5 rounded-full bg-white flex justify-center mx-auto">
                            <div class="flex-col justify-center my-auto">
                                <svg id="moon" aria-hidden="true" focusable="false" data-prefix="fas"
                                    data-icon="moon-stars" class="svg-inline--fa fa-moon-stars h-3 w-4 hidden"
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" id="sun" class="h-4 w-4" fill="none"
                    ...
                    <div class="flex space-x-7">
                        <div>
                            ...
                            <a href="/" class="flex items-center py-0 px-2">
                                <svg aria-hidden="true" focusable="false" data-prefix="fab" data-icon="hooli"
                                    class="svg-inline--fa fa-hooli h-20 w-auto" role="img"
                        ...
                        <div class="hidden md:flex items-center space-x-1">
                            <ol id="navigation-ol" class="navigation-ol flex flex-wrap md:inline-flex list-none">
                                ...
                                <li class="navigation-links mx-3"><a href="/live-dev-page/" class="font-semibold">Live
                                        Dev Page</a></li>
                                <li class="navigation-links mx-3"><a href="/default-page-template/"
                                        class="font-semibold">Default Page Template</a></li>
                            </ol>
                        </div>
                    </div>
...
<path d="M4 6h16M4 12h16M4 18h16"></path>
                        ...
                        <button class="outline-none mobile-menu-button">
                            <svg xmlns="http://www.w3.org/2000/svg" width="75" height="75" viewBox="0 0 200 200"
                                class=" hover:" shape-rendering="crispEdges">
                                <g stroke-width="6.5" stroke-linecap="round">
                                    <path d="M72 82.286h28.75" fill="currentColor" fill-rule="evenodd"
                                    ...
                                    <path d="M72 125.143h28.75" fill="currentColor" fill-rule="evenodd"
                                        stroke="currentColor" shape-rendering="crispEdges" />
                                    <path
                                        d="M100.75 103.714l-71.908-.143c.026-39.638 32.352-71.674 72.23-71.674 39.876 0 72.203 32.036 72.203 71.554"
                                        fill="none" stroke="currentColor" shape-rendering="crispEdges" />
                                    <path d="M100.75 82.286h28.75" fill="currentColor" fill-rule="evenodd"
                                        stroke="currentColor" />
                                    <path d="M100.75 125.143h28.75" fill="currentColor" fill-rule="evenodd"
                                        stroke="currentColor" />
                                </g>
                            </svg>
                        </button>
            ...
            <div class="hidden md:hidden absolute w-full z-50 mobile-menu bg-gray-200 dark:bg-gray-700">
                <ol id="navigation-ol-mobile" class="navigation-ol-mobile list-none">
                    ...
                    <li class="navigation-links-mobile"><a href="/live-dev-page/"
                            class="navigation-links flex justify-center mx-auto px-2 py-4 hover:bg-gray-500 transition motion-reduce:transition-none duration-250 text-xl">Live
                            Dev Page</a></li>
                    <li class="navigation-links-mobile"><a href="/default-page-template/"
                            class="navigation-links flex justify-center mx-auto px-2 py-4 hover:bg-gray-500 transition motion-reduce:transition-none duration-250 text-xl">Default
                            Page Template</a></li>
                    <li class="navigation-links-mobile"><a href="/test2/"
                            class="navigation-links flex justify-center mx-auto px-2 py-4 hover:bg-gray-500 transition motion-reduce:transition-none duration-250 text-xl">Test</a>
                    </li>
                </ol>
                <div
                    class="flex justify-center mx-auto text-zinc-400 dark:text-yellow-100 border-t border-gray-300 dark:border-gray-500">
                    <label for="toggle2" id="checkbox2"
                        ...
                        <div class="relative">
                            ...
                            <div id="dot2"
                                ...
                                <div class="flex-col justify-center my-auto">
                                    <svg id="moon2" aria-hidden="true" focusable="false" data-prefix="fas"
                                        data-icon="moon-stars" class="svg-inline--fa fa-moon-stars h-4 w-5 hidden"
                                        role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                                        <path fill="currentColor"
                                            d="M332.2 426.4c-93.1 17.7-178.5-53.7-178.5-147.7 0-54.2 29-104 76.1-130.8 7.3-4.1 5.4-15.1-2.8-16.7C108.7 109.4 0 200 0 320c0 106 85.8 192 191.8 192 59.2 0 113.2-26.9 149-71.1 5.3-6.5-.5-16.1-8.6-14.5zM304 96l16-32 32-16-32-16-16-32-16 32-32 16 32 16 16 32zm154.7 85.3L432 128l-26.7 53.3L352 208l53.3 26.7L432 288l26.7-53.3L512 208l-53.3-26.7z">
                                        </path>
                                    </svg>
                                    <svg xmlns="http://www.w3.org/2000/svg" id="sun2" class="h-5 w-5" fill="none"
                                        viewBox="0 0 24 24" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                            d="M12 3v1m0 16v1m9-9h-1M4 12H3m15.364 6.364l-.707-.707M6.343 6.343l-.707-.707m12.728 0l-.707.707M6.343 17.657l-.707.707M16 12a4 4 0 11-8 0 4 4 0 018 0z" />
                                    </svg>
