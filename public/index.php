...
<div class="flex-col">
<h1 class="pb-4"><span class="font-extrabold text-white text-3xl md:text-4xl lg:text-5xl text-shadow-lg">Our product is service.</span></h1>
...
transition motion-reduce:transition-none duration-250"' . 'data-src="' . $imgLocation . $imgName . '-xs.jpg"' . 
'srcset="' . $imgLocation . $imgName . '-xs.jpg 320w,' . $imgLocation . $imgName . '-sm.jpg 375w,' . $imgLocation . $imgLocation . $imgName . '-md.jpg 768w,' . $imgLocation . $imgName . '-lg.jpg 960w,' .
$imgLocation . $imgName . '-lg.jpg 1024w,' . $imgLocation . $imgName . '-xl.jpg 1400w,' . $imgLocation . $imgName . '-2xl.jpg 1536w,"' .
...
<input type="text" name="name" placeholder="John Doe" required class="w-full px-3 py-2 placeholder-gray-300 dark:bg-gray-400 border border-gray-300 rounded-md focus:outline-none focus:ring focus:ring-gray-100 focus:border-gray-300"/>
</div>
<div class="mb-6">
<label for="email" class="block mb-2 text-sm text-gray-600 dark:text-gray-400">Email Address</label>
<input type="email" name="email" placeholder="your@email.com" required class="w-full px-3 py-2 placeholder-gray-300 dark:bg-gray-400 border border-gray-300 rounded-md focus:outline-none focus:ring focus:ring-gray-100 focus:border-gray-300"/>
</div>
<div class="mb-6">
<label for="phone" class="text-sm text-gray-600 dark:text-gray-400">Phone Number</label>
<input type="text" name="phone" placeholder="617-1234-567" required class="w-full px-3 py-2 placeholder-gray-300 dark:bg-gray-400 border border-gray-300 rounded-md focus:outline-none focus:ring focus:ring-gray-100 focus:border-gray-300"/>
</div>
<div class="mb-6">
<label for="message" class="block mb-2 text-sm text-gray-600 dark:text-gray-400">Your Message</label>
<textarea rows="5" name="message" placeholder="Your Message" class="w-full px-3 py-2 placeholder-gray-300 dark:bg-gray-400 border border-gray-300 rounded-md focus:outline-none focus:ring focus:ring-gray-100 focus:border-gray-300" required>
</textarea>
</div>
<div class="mb-6">
<button type="submit" class="w-full px-2 py-4 text-white bg-gray-500 rounded-md focus:bg-gray-600 focus:outline-none">Send Message</button>
</div>
</form>
</div>
</div>
