...
<main id="main" role="main" class="flex flex-auto flex-col w-full justify-center">
  <div class="flex-col w-full h-full max-w-screen-sm md:max-w-3xl mx-auto px-3 py-16 prose lg:prose-xl dark:prose-invert">
        ...
        <form action="https://formspree.io/f/xvolkjak" method="POST">
          ...
          <div class="mb-6">
            <label for="message" class="block mb-2 text-sm text-gray-600 dark:text-gray-400">Your
              message</label>
            <textarea role="textbox" rows=" 5" name="message" placeholder="Your Message" class="w-full px-3 py-2 placeholder-gray-300 dark:bg-gray-400 border border-gray-300 rounded-md focus:outline-none focus:ring focus:ring-gray-100 focus:border-gray-300" aria-required="false" aria-placeholder="Your message" aria-label="Your message">
            </textarea>
          </div>
          <div class="mb-6">
            <button type="submit" role="button" class="w-full px-2 py-4 text-white bg-gray-500 rounded-md focus:bg-gray-600 focus:outline-none">Send
              Message</button>
          </div>
        </form>
      </div>
