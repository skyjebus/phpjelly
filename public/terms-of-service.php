...
<main class="flex w-full py-10">
    <section class="px-2 mx-auto max-w-5xl leading-6">
        ...
        <p>Company (referred to as either "the Company", "We", "Us" or "Our" in this Agreement)
            refers to <?php echo $name; ?>, <?php echo $address . " " . $al2 . " " . $city . " " . $state . " " . $zip; ?></p>
        ...
        <p>Terms and Conditions (also referred as "Terms") mean these Terms and Conditions that form
            the entire agreement between You and the Company regarding the use of the Service.</p>
        <p>Third-party Social Media Service means any services or content (including data,
            information, products or services) provided by a third-party that may be displayed, Inc
            luded or made available by the Service.</p>
        ...
        <p>To the maximum extent permitted by applicable law, in no event shall the Company or its
            suppliers be liable for any special, Inc idental, indirect, or consequential damages
        ...
        <p>The Service is provided to You "AS IS" and "AS AVAILABLE" and with all faults and defects
            ...
            implied, statutory or otherwise, with respect to the Service, Inc luding all implied
